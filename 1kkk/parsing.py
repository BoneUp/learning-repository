...
def get_img(url):
    wb_data = requests.get(url, headers=headers)
    soup = BeautifulSoup(wb_data.text, 'lxml')
    img_links = soup.select('img[id="cp_img"]')
...
if __name__ == '__main__':
    get_img(
        'http://manhua1032-61-174-50-98.cdndm5.com/22/21573/555140/17_7482.jpg?cid=555140&key=520bc5f7774440c8708e79ad0aafd8c2'
    )
